<?php
include "header.php";
include "Controller/homepage/homepage_data.php";
include "Controller/aboutpage/aboutpage_data.php";
include "Controller/servicespage/servicespage_data.php";
include "Controller/testimonial/testimonial_data.php";
?>
<!-- slider section -->
      ...
      <div class="owl-carousel">
        ...
        <div class="item">
          <div class="box">
            <div class="client_id">
              <div class="img-box">
                <img src="images/<?=$testimonial_ımageurl?>" alt="">
              </div>
              <div class="client_detail">
                <div class="client_info">
                  <h6>
